...
async def run_test():
    ...
    try:
        ...
        await expect(page.locator("xpath=/html/body/section[1]/div/form/div[1]/div[1]/div/input").nth(0)).to_be_visible(timeout=15000), "The Email input is visible on the login screen."
        ...
        await expect(page.locator("xpath=/html/body/section[1]/div/form/div[1]/div[2]/div/div/input").nth(0)).to_be_visible(timeout=15000), "The Password input is visible on the login screen."
        ...
        # --> Verify protected dashboard content is not displayed
        # Assert: The user is on the /admin/login page, confirming protected dashboard content is not displayed.
        await expect(page).to_have_url(re.compile("/admin/login"), timeout=15000), "The user is on the /admin/login page, confirming protected dashboard content is not displayed."
