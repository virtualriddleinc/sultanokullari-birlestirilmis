...
export const nedenSultanItems: NedenItem[] = [
  {
    headline: "Temiz, huzurlu ve mutlu… Sultan Okulları",
  ...
  },
  {
    ...
    body: "Bilgilerin satırlarda değil sadırlarda olmasını önemsiyor, yaparak ve yaşatarak öğrencilerimize uygulamalı bir eğitim sağlıyoruz.",
  },
  {
    headline: "Butik okulla çocuklarımız güvende",
    body: "Butik okul projemizle öğrencilerimize birebir olarak ayırdığımız zamanı çoğaltıyor, onların sosyalleşmelerine ve akademik başarılarına daha çok yardımcı oluyoruz.",
  },
  {
    headline: "Sultan Okullarında öğrencilerimiz doğayla iç içe",
