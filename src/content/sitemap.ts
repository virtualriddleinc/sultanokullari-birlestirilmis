...
export const SITEMAP_CATEGORIES: SitemapCategory[] = [
  ...
  },
  {
    ...
    icon: BookOpen,
    links: [
      { title: "Sultan Mektep Modeli & Kademeler", path: "/egitim/kademeler" },
      ...
      { title: "Hafızlık Eğitimi", path: "/egitim/hafizlik" },
  ...
  },
  {
    ...
    icon: Award,
    links: [
      { title: "Akademik Gelişim ve Takip", path: "/akademik/gelisim" },
