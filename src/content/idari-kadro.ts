...
export const idariKadro: StaffMember[] = [
  ...
  // Sakarya — Özel Sultan Anne Anaokulu (Serdivan)
  {
    id: "sr-i1",
    name: "Hediye Erdem Kaya",
    title: "Kurum Müdürü",
    education: "Yüksek Lisans – Sakarya Üniversitesi, Eğitim Yönetimi ve Denetimi",
    department: "idari",
    branchSlug: "serdivan",
  },
  {
    id: "sr-e1",
    name: "Beyzanur Burcu",
    title: "Değerler Eğitimi Öğretmeni",
    education: "Lisans – Sakarya Üniversitesi İlahiyat Fakültesi",
    department: "egitim",
    branchSlug: "serdivan",
  },
  {
    ...
    education: "Ön Lisans – Atatürk Üniversitesi Çocuk Gelişimi",
    department: "egitim",
    branchSlug: "serdivan",
  },
  {
    ...
    name: "Fatma Turan",
    title: "Sınıf Öğretmeni",
    education: "Ön Lisans – Anadolu Üniversitesi Çocuk Gelişimi ve Eğitimi",
    department: "egitim",
    branchSlug: "serdivan",
  },

  // Ankara — Özel Sincan Sultan Anne Anaokulu
  {
    id: "sc-i1",
    name: "Gülay Beyza Demir",
    title: "Kurucu Temsilcisi",
    department: "idari",
    branchSlug: "sincan",
  },
  {
  ...
  {
    id: "sc-e1",
    name: "Gül Betül Demir",
    title: "Çocuk Gelişimi Öğretmeni",
    education: "Lisans",
    department: "egitim",
    branchSlug: "sincan",
  },
  {
    id: "sc-e2",
    name: "Arife Sultan Karaköse",
    title: "Kulüp Öğretmeni",
    education: "Lisans",
    department: "egitim",
    branchSlug: "sincan",
  },
  {
    id: "sc-e3",
    name: "Ruveyda Elitok",
    title: "Çocuk Gelişimi Uzman Öğretici",
    education: "Ön lisans",
    department: "egitim",
    branchSlug: "sincan",
  },
